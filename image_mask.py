...
color_mat = loadmat('E:/HyGSTAN/data/AVIRIS_colormap.mat')
color_mat_list = list(color_mat)
color_matrix = color_mat[color_mat_list[3]] #(17,3)

# pred = Image.open('barbara.tif')
# data_label = loadmat("E:/HyGSTAN/data/Barbara/barbara_gtChanges.mat")['HypeRvieW']

pred = Image.open('BayArea.tif')
data_label = loadmat("E:/HyGSTAN/data/BayArea/bayArea_gtChanges2.mat")['HypeRvieW']
