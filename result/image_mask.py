...
data_label = loadmat("E:/IEEE_TGRS_HyGSTAN-main/data/Barbara/barbara_gtChanges.mat")['HypeRvieW']

# pred = Image.open('BayArea.tif')
# data_label = loadmat("E:/IEEE_TGRS_HyGSTAN-main/data/BayArea/bayArea_gtChanges2.mat")['HypeRvieW']
